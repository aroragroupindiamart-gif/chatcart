...
## UPDATE — "Most Popular" badge placement (supersedes earlier instruction in this file)

Move the "Most Popular" badge from Growth to Pro (₹299). Pro should now be the visually highlighted/recommended tier on the pricing page. Growth and Starter display as standard cards with no badge.
